...
# Voor elk domein in het configuratiebestand:
for domain in domains:
	# 'DNS Instellen' pagina openen
	a = driver.execute_script("puntapi.DoCommand('dnsclient','dnsadmin','','','');")
	element = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.NAME, "Formid"))) # Wacht tot de pagina is geladen
	...
	element = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, "//div[text()='DNS opgeslagen']"))) # Wacht op confirmatie
